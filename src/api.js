import {multipartDecode, multipartEncode} from "./message.js";
...
class DICOMwebClient {
  ...
  _axiosRequest(url, method, headers, options = {}) {
    ...
    return new Promise((resolve, reject) => {
      ...
      authorizedAxiosClient.request(axiosOptions)
        .then(({data}) => {
          resolve(data || []);
        })
        .catch((error) => {
  ...
  _xhrRequest(url, method, headers, options = {}) {
    return new Promise((resolve, reject) => {
